...
func TestPreviewReclaimTargets(t *testing.T) {
	t.Parallel()

	t.Run("use pointer-scoped stack names", func(t *testing.T) {
		t.Parallel()
...
func TestReclaimTargetsFor(t *testing.T) {
	t.Parallel()

	t.Run("an empty pointer resolves production stacks", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("a named pointer resolves preview stacks", func(t *testing.T) {
		t.Parallel()
...
func TestClassifyPreviewStacks(t *testing.T) {
	...
	t.Run("splits infra app and pointers", func(t *testing.T) {
		...
		slices.Sort(got.InfraStacks)
		slices.Sort(got.AppStacks)
	...
	t.Run("excludes production and siblings", func(t *testing.T) {
		t.Parallel()
		got := classifyPreviewStacks("shop", []string{
			InfraStackName("shop"),
