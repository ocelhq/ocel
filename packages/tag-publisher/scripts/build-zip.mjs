...
//
// The publisher has no native dependency, so unlike the image optimizer there is
// no cross-install and no node_modules tree to stage — the whole function is one
// file:
...
const zip = join(root, "dist", "tag-publisher.zip");
