...
// accessor generated for the project at `.ocel/env-client.ts`, not to this
// file.
//
// It is generated, and generated into the project, because of what the
...
export const clientEnv: ClientEnv = new Proxy({} as ClientEnv, {
  get(_target, property) {
    ...
    throw new EnvClientError(
      `'${property}' cannot be read: no client accessor was generated for this project, so 'ocel/env/client' resolved to its unresolved fallback. Run \`ocel dev\` or \`ocel deploy\`, which write '.ocel/env-client.ts' during discovery.`,
    );
  },
});
