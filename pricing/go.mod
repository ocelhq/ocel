module github.com/ocelhq/ocel/pricing
...
replace github.com/ocelhq/ocel/platform/gcp/provider => ../platform/gcp/provider
...
require (
	...
	github.com/ocelhq/ocel/platform/gcp/provider v0.0.0-00010101000000-000000000000
