...
_PostgresPropertiesFields: TypeAlias = Literal["host", "port", "database", "username", "password", "url", "tls_mode", "tls_ca"]
...
class PostgresProperties(Message[_PostgresPropertiesFields]):
    ...
    Attributes:
        ...
        tls_mode:
            ```proto
            common.bindings.v1.PostgresTlsMode tls_mode = 7;
            ```
        tls_ca:
            ```proto
            string tls_ca = 8;
    ...
    __slots__ = ("host", "port", "database", "username", "password", "url", "tls_mode", "tls_ca")
    ...
    if TYPE_CHECKING:
        ...
        def __init__(
            ...
            *,
            ...
            password: str = "",
            url: str = "",
            tls_mode: PostgresTlsMode | None = None,
            tls_ca: str = "",
        ) -> None:
            pass
...
_BucketPropertiesFields: TypeAlias = Literal["bucket", "public_base_url", "public", "endpoint", "region", "path_style", "prefix", "access_key_id", "secret_access_key"]
...
class BucketProperties(Message[_BucketPropertiesFields]):
    ...
    __slots__ = ("bucket", "public_base_url", "public", "endpoint", "region", "path_style", "prefix", "access_key_id", "secret_access_key")
...
class PostgresTlsMode(Enum):
    """
    ```proto
    enum common.bindings.v1.PostgresTlsMode
    ```
