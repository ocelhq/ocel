...
func TestAppExecutionRole_CarriesTheSubstratesVarsKey(t *testing.T) {
	...
	role := appExecutionRole(Config{VarsKeyARN: productionVarsKeyARN}, "proj", "web", caches, appBundle{}, nil)
	...
	preview := appExecutionRole(Config{VarsKeyARN: previewVarsKeyARN}, "proj", "api", caches, appBundle{}, nil)
