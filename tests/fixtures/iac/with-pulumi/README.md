...
Rung three of the [fixture ladder](../../sdk/with-transforms), in Pulumi rather than
[SST](../with-sst), and building on the same two rungs: Pulumi owns the database and the
