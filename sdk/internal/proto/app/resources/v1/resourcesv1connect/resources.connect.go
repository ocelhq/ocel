...
import (
	...
	errors "errors"
	http "net/http"
	v1 "ocel.dev/internal/proto/app/resources/v1"
	strings "strings"
)
...
const (
	...
	ResourceServiceName = "app.resources.v1.ResourceService"
)
...
const (
	...
	ResourceServiceReportEnvProblemsProcedure = "/app.resources.v1.ResourceService/ReportEnvProblems"
)
...
// NewResourceServiceClient constructs a client for the app.resources.v1.ResourceService service. By
...
func NewResourceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ResourceServiceClient {
	...
	resourceServiceMethods := v1.File_app_resources_v1_resources_proto.Services().ByName("ResourceService").Methods()
...
// DeclareEnv calls app.resources.v1.ResourceService.DeclareEnv.
...
// ReportEnvProblems calls app.resources.v1.ResourceService.ReportEnvProblems.
...
func NewResourceServiceHandler(svc ResourceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app.resources.v1.ResourceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedResourceServiceHandler) DeclareEnv(context.Context, *v1.DeclareEnvRequest) (*v1.DeclareEnvResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.resources.v1.ResourceService.DeclareEnv is not implemented"))
}
...
func (UnimplementedResourceServiceHandler) ReportEnvProblems(context.Context, *v1.ReportEnvProblemsRequest) (*v1.ReportEnvProblemsResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("app.resources.v1.ResourceService.ReportEnvProblems is not implemented"))
}
