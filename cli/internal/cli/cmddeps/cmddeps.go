...
type Deps struct {
	...
	RequireImageBuilder func(ctx context.Context, rep runui.Reporter, cfg *projectconfig.Config, arch string) error
	BuildAppImages      func(ctx context.Context, cfg *projectconfig.Config, arch string, out io.Writer) (map[string]string, error)
