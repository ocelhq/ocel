...
const inlinedHelper = `const inlined = (key, value) => {
...
// naming the variable. The file carries no type syntax, so it is the same text
// under every bundler that reads it.
