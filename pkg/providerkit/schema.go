...
func EnsureRecordSchema(ctx context.Context, store records.Store, class edge.Class) error {
...
func RecordSchema(ctx context.Context, store records.Store, class edge.Class) (int, error) {
	held, err := records.ReadOrEmpty(ctx, store, SchemaRecord(class))
	if err != nil {
