// The Pulumi adapter for providerkit's Releaser port. It is a module of its own
// so a vendor that provisions without Pulumi never pulls the engine's dependency
// tree into its build — composition, not a requirement.
module github.com/ocelhq/ocel/pkg/providerkit/pulumi
...
require (
	...
	github.com/ocelhq/ocel/pkg/channel v0.0.0-20260821173752-eac661f05a64 // indirect
...
replace github.com/ocelhq/ocel/pkg/providerkit => ../
