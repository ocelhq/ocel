...
type Document struct {
	...
	Discovery     *Discovery      `json:"discovery,omitempty" doc:"Where the resources an app declares are found."`
	Provider      *Provider       `json:"provider,omitempty" doc:"The provider ocel deploy provisions into."`
	Edge          *Edge           `json:"edge,omitempty" doc:"The edge in front of the origin. Omit it and the provider fronts the deployment with its own default edge."`
	DNS           *DNS            `json:"dns,omitempty" doc:"Where the project's hostname records are written."`
	AllowDegraded []string        `json:"allowDegraded,omitempty" doc:"The needs this project waives rather than have a deploy refused over."`
	Apps          []App           `json:"apps,omitempty" doc:"The apps this project deploys. Left off, ocel detects one at the project root."`
	Domains       *ProjectDomains `json:"domains,omitempty" doc:"The hostnames this project is served on."`
	Registry      *Registry       `json:"registry,omitempty" doc:"Where this project's container images are pushed."`
}
...
type App struct {
	...
	Domains    *AppDomains `json:"domains,omitempty" doc:"The hostnames this app is served on."`
	Build      *Build      `json:"build,omitempty" doc:"How a container app's image is built."`
	Health     *Health     `json:"health,omitempty" doc:"How a container app is checked before it is served."`
}
