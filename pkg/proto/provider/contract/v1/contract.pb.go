...
const file_provider_contract_v1_contract_proto_rawDesc = "" +
	...
	"\fDomainsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x126\n" +
	"\x05value\x18\x02 \x01(\v2 .provider.contract.v1.DomainListR\x05value:\x028\x01\"\xe6\x01\n" +
	"\x10ManifestVariable\x12+\n" +
	"\x03key\x18\x01 \x01(\tB\x19\xbaH\x16r\x14\x10\x012\x10^[^#[:cntrl:]]*$R\x03key\x12?\n" +
	"\x05class\x18\x02 \x01(\x0e2\x1f.app.resources.v1.VariableClassB\b\xbaH\x05\x82\x01\x02\x10\x01R\x05class\x12\x14\n" +
