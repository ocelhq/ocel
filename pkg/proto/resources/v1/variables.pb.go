...
const file_resources_v1_variables_proto_rawDesc = "" +
	...
	"\x05cells\x18\x01 \x03(\v2\x1a.resources.v1.VariableCellR\x05cells\"\xf5\x01\n" +
	"\x0fVariableProblem\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x06folder\x18\x02 \x01(\tB\x1c\xbaH\x19r\x172\x15^(/[^/#[:cntrl:]]+)*$R\x06folder\x12@\n" +
	"\x04kind\x18\x03 \x01(\x0e2\".resources.v1.VariableProblem.KindB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04kind\x12\x16\n" +
