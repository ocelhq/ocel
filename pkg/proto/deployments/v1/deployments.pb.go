...
func (EdgeStackPlan_Item_Action) EnumDescriptor() ([]byte, []int) {
	return file_deployments_v1_deployments_proto_rawDescGZIP(), []int{18, 0, 0}
}
...
func (DomainClaim_Status) EnumDescriptor() ([]byte, []int) {
	return file_deployments_v1_deployments_proto_rawDescGZIP(), []int{25, 0}
}
...
var file_deployments_v1_deployments_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_deployments_v1_deployments_proto_goTypes = []any{
	...
	(*DestroyPreviewRequest)(nil),      // 22: deployments.v1.DestroyPreviewRequest
	(*DestroyProjectRequest)(nil),      // 23: deployments.v1.DestroyProjectRequest
	(*PlanDestroyProjectRequest)(nil),  // 24: deployments.v1.PlanDestroyProjectRequest
	(*PlanDestroyProjectResponse)(nil), // 25: deployments.v1.PlanDestroyProjectResponse
	(*EdgeStackPlan)(nil),              // 26: deployments.v1.EdgeStackPlan
	(*ListEnvironmentsRequest)(nil),    // 27: deployments.v1.ListEnvironmentsRequest
	(*ListEnvironmentsResponse)(nil),   // 28: deployments.v1.ListEnvironmentsResponse
	(*PreviewEnvironment)(nil),         // 29: deployments.v1.PreviewEnvironment
	(*PreflightRequest)(nil),           // 30: deployments.v1.PreflightRequest
	(*PreflightResponse)(nil),          // 31: deployments.v1.PreflightResponse
	(*GlobalPreviewDomain)(nil),        // 32: deployments.v1.GlobalPreviewDomain
	(*DomainClaim)(nil),                // 33: deployments.v1.DomainClaim
	(*Identity)(nil),                   // 34: deployments.v1.Identity
	(*CredentialProblem)(nil),          // 35: deployments.v1.CredentialProblem
	(*Promotion)(nil),                  // 36: deployments.v1.Promotion
	(*PromotionHistoryEntry)(nil),      // 37: deployments.v1.PromotionHistoryEntry
	(*ListPromotionsRequest)(nil),      // 38: deployments.v1.ListPromotionsRequest
	(*ListPromotionsResponse)(nil),     // 39: deployments.v1.ListPromotionsResponse
	(*RollbackRequest)(nil),            // 40: deployments.v1.RollbackRequest
	(*RollbackResponse)(nil),           // 41: deployments.v1.RollbackResponse
	(*PruneRequest)(nil),               // 42: deployments.v1.PruneRequest
	(*DeployEvent)(nil),                // 43: deployments.v1.DeployEvent
	(*Stage)(nil),                      // 44: deployments.v1.Stage
	(*StagePlanEvent)(nil),             // 45: deployments.v1.StagePlanEvent
	(*SpanAttribute)(nil),              // 46: deployments.v1.SpanAttribute
	(*SpanEvent)(nil),                  // 47: deployments.v1.SpanEvent
	(*ProgressEvent)(nil),              // 48: deployments.v1.ProgressEvent
	(*LogEvent)(nil),                   // 49: deployments.v1.LogEvent
	(*ResultEvent)(nil),                // 50: deployments.v1.ResultEvent
	(*FunctionOutput)(nil),             // 51: deployments.v1.FunctionOutput
	(*SetLinkRequest)(nil),             // 52: deployments.v1.SetLinkRequest
	(*SetLinkResponse)(nil),            // 53: deployments.v1.SetLinkResponse
	(*RemoveLinkRequest)(nil),          // 54: deployments.v1.RemoveLinkRequest
	(*RemoveLinkResponse)(nil),         // 55: deployments.v1.RemoveLinkResponse
	(*ListLinksRequest)(nil),           // 56: deployments.v1.ListLinksRequest
	(*ListLinksResponse)(nil),          // 57: deployments.v1.ListLinksResponse
	(*LinkSummary)(nil),                // 58: deployments.v1.LinkSummary
	(*PropertyShape)(nil),              // 59: deployments.v1.PropertyShape
	nil,                                // 60: deployments.v1.Manifest.DomainsEntry
	nil,                                // 61: deployments.v1.ManifestApp.DomainsEntry
	(*EdgeStackPlan_Item)(nil),         // 62: deployments.v1.EdgeStackPlan.Item
	nil,                                // 63: deployments.v1.Promotion.BuildsEntry
	(v1.VariableClass)(0),              // 64: resources.v1.VariableClass
	(*v1.ResourceIdentifier)(nil),      // 65: resources.v1.ResourceIdentifier
	(*v1.PostgresConfig)(nil),          // 66: resources.v1.PostgresConfig
	(*v1.BucketConfig)(nil),            // 67: resources.v1.BucketConfig
	(*v11.Link)(nil),                   // 68: links.v1.Link
	(v11.LinkType)(0),                  // 69: links.v1.LinkType
}
var file_deployments_v1_deployments_proto_depIdxs = []int32{
	...
	32, // 2: deployments.v1.ListDomainResponse.domain:type_name -> deployments.v1.GlobalPreviewDomain
	...
	60, // 9: deployments.v1.Manifest.domains:type_name -> deployments.v1.Manifest.DomainsEntry
	...
	61, // 12: deployments.v1.ManifestApp.domains:type_name -> deployments.v1.ManifestApp.DomainsEntry
	17, // 13: deployments.v1.ManifestApp.variables:type_name -> deployments.v1.ManifestVariable
	64, // 14: deployments.v1.ManifestVariable.class:type_name -> resources.v1.VariableClass
	65, // 15: deployments.v1.ManifestResource.resource:type_name -> resources.v1.ResourceIdentifier
	66, // 16: deployments.v1.ManifestResource.postgres:type_name -> resources.v1.PostgresConfig
	67, // 17: deployments.v1.ManifestResource.bucket:type_name -> resources.v1.BucketConfig
	...
	12, // 21: deployments.v1.DestroyPreviewRequest.environment:type_name -> deployments.v1.Environment
	12, // 22: deployments.v1.DestroyProjectRequest.environment:type_name -> deployments.v1.Environment
	26, // 23: deployments.v1.PlanDestroyProjectResponse.edge_stack:type_name -> deployments.v1.EdgeStackPlan
	62, // 24: deployments.v1.EdgeStackPlan.items:type_name -> deployments.v1.EdgeStackPlan.Item
	29, // 25: deployments.v1.ListEnvironmentsResponse.environments:type_name -> deployments.v1.PreviewEnvironment
	4,  // 26: deployments.v1.PreviewEnvironment.lifecycle:type_name -> deployments.v1.Environment.Lifecycle
	3,  // 27: deployments.v1.PreflightRequest.required_class:type_name -> deployments.v1.Environment.Class
	3,  // 28: deployments.v1.PreflightResponse.infra_class:type_name -> deployments.v1.Environment.Class
	34, // 29: deployments.v1.PreflightResponse.identity:type_name -> deployments.v1.Identity
	35, // 30: deployments.v1.PreflightResponse.credential_problems:type_name -> deployments.v1.CredentialProblem
	33, // 31: deployments.v1.PreflightResponse.domain_claims:type_name -> deployments.v1.DomainClaim
	32, // 32: deployments.v1.PreflightResponse.global_preview_domain:type_name -> deployments.v1.GlobalPreviewDomain
	7,  // 33: deployments.v1.DomainClaim.status:type_name -> deployments.v1.DomainClaim.Status
	63, // 34: deployments.v1.Promotion.builds:type_name -> deployments.v1.Promotion.BuildsEntry
	36, // 35: deployments.v1.PromotionHistoryEntry.promotion:type_name -> deployments.v1.Promotion
	37, // 36: deployments.v1.ListPromotionsResponse.promotions:type_name -> deployments.v1.PromotionHistoryEntry
	36, // 37: deployments.v1.RollbackResponse.promoted:type_name -> deployments.v1.Promotion
	12, // 38: deployments.v1.PruneRequest.environment:type_name -> deployments.v1.Environment
	48, // 39: deployments.v1.DeployEvent.progress:type_name -> deployments.v1.ProgressEvent
	49, // 40: deployments.v1.DeployEvent.log:type_name -> deployments.v1.LogEvent
	50, // 41: deployments.v1.DeployEvent.result:type_name -> deployments.v1.ResultEvent
	45, // 42: deployments.v1.DeployEvent.stage_plan:type_name -> deployments.v1.StagePlanEvent
	47, // 43: deployments.v1.DeployEvent.span:type_name -> deployments.v1.SpanEvent
	44, // 44: deployments.v1.StagePlanEvent.stages:type_name -> deployments.v1.Stage
	2,  // 45: deployments.v1.SpanAttribute.key:type_name -> deployments.v1.AttributeKey
	1,  // 46: deployments.v1.SpanEvent.status:type_name -> deployments.v1.SpanStatus
	46, // 47: deployments.v1.SpanEvent.attributes:type_name -> deployments.v1.SpanAttribute
	0,  // 48: deployments.v1.ProgressEvent.phase:type_name -> deployments.v1.Phase
	68, // 49: deployments.v1.ResultEvent.links:type_name -> links.v1.Link
	51, // 50: deployments.v1.ResultEvent.functions:type_name -> deployments.v1.FunctionOutput
	3,  // 51: deployments.v1.SetLinkRequest.class:type_name -> deployments.v1.Environment.Class
	68, // 52: deployments.v1.SetLinkRequest.link:type_name -> links.v1.Link
	3,  // 53: deployments.v1.RemoveLinkRequest.class:type_name -> deployments.v1.Environment.Class
	3,  // 54: deployments.v1.ListLinksRequest.class:type_name -> deployments.v1.Environment.Class
	58, // 55: deployments.v1.ListLinksResponse.links:type_name -> deployments.v1.LinkSummary
	69, // 56: deployments.v1.LinkSummary.type:type_name -> links.v1.LinkType
	59, // 57: deployments.v1.LinkSummary.properties:type_name -> deployments.v1.PropertyShape
	15, // 58: deployments.v1.Manifest.DomainsEntry.value:type_name -> deployments.v1.DomainList
	15, // 59: deployments.v1.ManifestApp.DomainsEntry.value:type_name -> deployments.v1.DomainList
	6,  // 60: deployments.v1.EdgeStackPlan.Item.action:type_name -> deployments.v1.EdgeStackPlan.Item.Action
	20, // 61: deployments.v1.DeploymentService.Deploy:input_type -> deployments.v1.DeployRequest
	21, // 62: deployments.v1.DeploymentService.Bootstrap:input_type -> deployments.v1.BootstrapRequest
	22, // 63: deployments.v1.DeploymentService.DestroyPreview:input_type -> deployments.v1.DestroyPreviewRequest
	23, // 64: deployments.v1.DeploymentService.DestroyProject:input_type -> deployments.v1.DestroyProjectRequest
	24, // 65: deployments.v1.DeploymentService.PlanDestroyProject:input_type -> deployments.v1.PlanDestroyProjectRequest
	27, // 66: deployments.v1.DeploymentService.ListEnvironments:input_type -> deployments.v1.ListEnvironmentsRequest
	30, // 67: deployments.v1.DeploymentService.Preflight:input_type -> deployments.v1.PreflightRequest
	38, // 68: deployments.v1.DeploymentService.ListPromotions:input_type -> deployments.v1.ListPromotionsRequest
	40, // 69: deployments.v1.DeploymentService.Rollback:input_type -> deployments.v1.RollbackRequest
	42, // 70: deployments.v1.DeploymentService.Prune:input_type -> deployments.v1.PruneRequest
	8,  // 71: deployments.v1.DeploymentService.UseDomain:input_type -> deployments.v1.UseDomainRequest
	9,  // 72: deployments.v1.DeploymentService.ListDomain:input_type -> deployments.v1.ListDomainRequest
	11, // 73: deployments.v1.DeploymentService.ReleaseDomain:input_type -> deployments.v1.ReleaseDomainRequest
	52, // 74: deployments.v1.DeploymentService.SetLink:input_type -> deployments.v1.SetLinkRequest
	54, // 75: deployments.v1.DeploymentService.RemoveLink:input_type -> deployments.v1.RemoveLinkRequest
	56, // 76: deployments.v1.DeploymentService.ListLinks:input_type -> deployments.v1.ListLinksRequest
	43, // 77: deployments.v1.DeploymentService.Deploy:output_type -> deployments.v1.DeployEvent
	43, // 78: deployments.v1.DeploymentService.Bootstrap:output_type -> deployments.v1.DeployEvent
	43, // 79: deployments.v1.DeploymentService.DestroyPreview:output_type -> deployments.v1.DeployEvent
	43, // 80: deployments.v1.DeploymentService.DestroyProject:output_type -> deployments.v1.DeployEvent
	25, // 81: deployments.v1.DeploymentService.PlanDestroyProject:output_type -> deployments.v1.PlanDestroyProjectResponse
	28, // 82: deployments.v1.DeploymentService.ListEnvironments:output_type -> deployments.v1.ListEnvironmentsResponse
	31, // 83: deployments.v1.DeploymentService.Preflight:output_type -> deployments.v1.PreflightResponse
	39, // 84: deployments.v1.DeploymentService.ListPromotions:output_type -> deployments.v1.ListPromotionsResponse
	41, // 85: deployments.v1.DeploymentService.Rollback:output_type -> deployments.v1.RollbackResponse
	43, // 86: deployments.v1.DeploymentService.Prune:output_type -> deployments.v1.DeployEvent
	43, // 87: deployments.v1.DeploymentService.UseDomain:output_type -> deployments.v1.DeployEvent
	10, // 88: deployments.v1.DeploymentService.ListDomain:output_type -> deployments.v1.ListDomainResponse
	43, // 89: deployments.v1.DeploymentService.ReleaseDomain:output_type -> deployments.v1.DeployEvent
	53, // 90: deployments.v1.DeploymentService.SetLink:output_type -> deployments.v1.SetLinkResponse
	55, // 91: deployments.v1.DeploymentService.RemoveLink:output_type -> deployments.v1.RemoveLinkResponse
	57, // 92: deployments.v1.DeploymentService.ListLinks:output_type -> deployments.v1.ListLinksResponse
...
func file_deployments_v1_deployments_proto_init() {
	...
	file_deployments_v1_deployments_proto_msgTypes[35].OneofWrappers = []any{
	...
	file_deployments_v1_deployments_proto_msgTypes[40].OneofWrappers = []any{}
	type x struct{}
