...
const file_buckets_v1_buckets_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04size\x18\x03 \x01(\x03R\x04size\x12\x1b\n" +
	"\tmime_type\x18\x04 \x01(\tR\bmimeType\"\xe9\x01\n" +
	"\x14PresignUploadRequest\x12\x1f\n" +
	"\x06bucket\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06bucket\x127\n" +
	"\x05files\x18\x02 \x03(\v2\x17.buckets.v1.PresignFileB\b\xbaH\x05\x92\x01\x02\b\x01R\x05files\x12\x1a\n" +
	...
	"\x05files\x18\x02 \x03(\v2\x1b.buckets.v1.PresignedTargetR\x05files\"\x92\x01\n" +
	"\x1cVerifyUploadSignatureRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\tR\tsignature\x125\n" +
	"\x04file\x18\x03 \x01(\v2\x19.buckets.v1.CompletedFileB\x06\xbaH\x03\xc8\x01\x01R\x04file\"Q\n" +
