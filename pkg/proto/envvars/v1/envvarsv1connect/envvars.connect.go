...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ocelhq/ocel/pkg/proto/envvars/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EnvVarsServiceName = "envvars.v1.EnvVarsService"
)
...
// NewEnvVarsServiceClient constructs a client for the envvars.v1.EnvVarsService service. By
...
func NewEnvVarsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EnvVarsServiceClient {
	...
	envVarsServiceMethods := v1.File_envvars_v1_envvars_proto.Services().ByName("EnvVarsService").Methods()
...
// SetValue calls envvars.v1.EnvVarsService.SetValue.
...
// ListValues calls envvars.v1.EnvVarsService.ListValues.
...
// GetValue calls envvars.v1.EnvVarsService.GetValue.
...
// RevealValues calls envvars.v1.EnvVarsService.RevealValues.
...
// DeleteValue calls envvars.v1.EnvVarsService.DeleteValue.
...
// SetReference calls envvars.v1.EnvVarsService.SetReference.
...
// ListReferences calls envvars.v1.EnvVarsService.ListReferences.
...
// ListVersions calls envvars.v1.EnvVarsService.ListVersions.
...
// SetLink calls envvars.v1.EnvVarsService.SetLink.
...
// RemoveLink calls envvars.v1.EnvVarsService.RemoveLink.
...
// ListLinks calls envvars.v1.EnvVarsService.ListLinks.
...
// EnvVarsServiceHandler is an implementation of the envvars.v1.EnvVarsService service.
...
func NewEnvVarsServiceHandler(svc EnvVarsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/envvars.v1.EnvVarsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEnvVarsServiceHandler) SetValue(context.Context, *v1.SetValueRequest) (*v1.SetValueResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.SetValue is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) ListValues(context.Context, *v1.ListValuesRequest) (*v1.ListValuesResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.ListValues is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) GetValue(context.Context, *v1.GetValueRequest) (*v1.GetValueResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.GetValue is not implemented"))
}
...
func (UnimplementedEnvVarsServiceHandler) RevealValues(context.Context, *v1.RevealValuesRequest) (*v1.RevealValuesResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.RevealValues is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) DeleteValue(context.Context, *v1.DeleteValueRequest) (*v1.DeleteValueResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.DeleteValue is not implemented"))
}
...
func (UnimplementedEnvVarsServiceHandler) SetReference(context.Context, *v1.SetReferenceRequest) (*v1.SetReferenceResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.SetReference is not implemented"))
}
...
func (UnimplementedEnvVarsServiceHandler) ListReferences(context.Context, *v1.ListReferencesRequest) (*v1.ListReferencesResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.ListReferences is not implemented"))
}
...
func (UnimplementedEnvVarsServiceHandler) ListVersions(context.Context, *v1.ListVersionsRequest) (*v1.ListVersionsResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.ListVersions is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) SetLink(context.Context, *v1.SetLinkRequest) (*v1.SetLinkResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.SetLink is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) RemoveLink(context.Context, *v1.RemoveLinkRequest) (*v1.RemoveLinkResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.RemoveLink is not implemented"))
}

func (UnimplementedEnvVarsServiceHandler) ListLinks(context.Context, *v1.ListLinksRequest) (*v1.ListLinksResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("envvars.v1.EnvVarsService.ListLinks is not implemented"))
}
