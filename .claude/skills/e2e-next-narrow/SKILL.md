...
description: Drive tests/e2e-next.js/baseline-manifest.json down — verify its entries, cluster what is still red, fix and promote. Usage — /e2e-next-narrow [focus and notes]
disable-model-invocation: true
---

# e2e-next-narrow

The work list is `tests/e2e-next.js/baseline-manifest.json` itself. `$ARGUMENTS` is a
...
Read `tests/e2e-next.js/run-suite-prompt.md` (isolation model, preflight, screening a
suite, reading a result) and `tests/e2e-next.js/README.md` (what the manifest is, how
