...
export async function save(): Promise<void> {
  ...
  try {
    ...
    await reveal(
      results
        .filter((result) => !result.ok && result.status === conflict)
